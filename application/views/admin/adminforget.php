  ...
  <!-- **************** for user login******************** -->
   <section class="login-section">
    <div class="container">
      ...
      <form action="<?php echo base_url('admin/forget_password/send_otp'); ?>" method="post">
          <div class="main2">
...
<form action="<?php echo base_url('admin/forget_password/verify_otp'); ?>" method="post">
                    ...
                    <div class="" >
                        ...
                        <button type="submit"  class="btn btn-success">Submit </button>
                            ...
                            <a href="<?php echo base_url('admin/login'); ?>" class="btn btn-primary" role="button">Cancel</a>
                        </div>
                    </div>
