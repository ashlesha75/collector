...
class Forget_password extends CI_Controller {
    ...
    public function send_otp() {
        ...
        if ($this->form_validation->run()) {
            ...
            $user_id = $this->Admin_Changepassword_Model->check_mobile_number($phone);
            ...
            if ($user_id === false) {
                ...
                redirect('admin/forget_password'); // Redirect to the forget_password index method
            }
    ...
    public function verify_otp() {
        ...
        if ($this->form_validation->run()) {
            ...
            if ($otp == $stored_otp) {
                ...
                // var_dump($phone); exit;
                redirect('admin/forget_password/changepass');
            } else {
    ...
    public function changepass() {
        $this->load->view('admin/adminchangepass');
    }
    ...
    public function changepassword() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $update_result = $this->Admin_Changepassword_Model->update_password($user_id, $new_password, $confirm_password);
    // var_dump($update_result); exit;
            if ($update_result === false) {
                ...
                redirect('admin/forget_password/changepassword'); // Redirect back to the change password page
            } elseif ($update_result) {
                // Password updated successfully, show success message or redirect to a success page
                $this->session->set_flashdata('success', 'Password updated successfully!');
                redirect('admin/login'); // Redirect to the login page after password change
            } else {
    ...
    private function send_otp_via_sms($to, $otp) {
        ...
        // $this->Admin_Changepassword_Model->sendMobileSms($to,$otp);
    }
